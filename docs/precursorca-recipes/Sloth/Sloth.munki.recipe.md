...
- **Description**: Downloads the latest version of Sloth and imports it into Munki.

- **Identifier**: `com.github.precursorca.munki.Sloth`

- **Parent Recipes**: `com.github.precursorca.download.Sloth`
