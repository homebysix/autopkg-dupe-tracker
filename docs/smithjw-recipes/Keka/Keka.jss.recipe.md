...
- **Description**: Downloads the current release version of Keka, builds a package, then uploads to the JSS.

- **Identifier**: `com.github.smithjw.jss.Keka`

- **Parent Recipes**: `com.github.smithjw.pkg.Keka`
