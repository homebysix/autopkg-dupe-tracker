# GoogleChrome.ds.recipe

            _Last updated 2021-12-23 19:58:07Z_

            - **Description**: Downloads latest version of Google Chrome, builds a package, and copies it to 
...
- DS_NAME is what the final package will be called in DeployStudio, regardless 
  ...
  version number appended.
            ...
            - **Identifier**: `com.github.triti.ds.googlechrome`
