...
- **Description**: Downloads the current release version of Viscosity, builds a package, then uploads to the JSS.

- **Identifier**: `com.github.smithjw.jss.Viscosity`

- **Parent Recipes**: `com.github.smithjw.pkg.Viscosity`
