# FontExplorerX4PluginID2014.pkg.recipe
...
in the plugin bundle. These are made into stand alone packages.
    ...
    - **Identifier**: `com.github.mosen.pkg.FontExplorerXPluginID2014`

    - **Parent Recipes**: `com.github.mosen.download.FontExplorerXProPlugins`