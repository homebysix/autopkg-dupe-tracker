...
- **Description**: Downloads the latest stable Fritzing and creates flat *.pkg installer.

- **Identifier**: `com.github.jps3.pkg.Fritzing`

- **Parent Recipes**: `com.github.jps3.download.Fritzing`
