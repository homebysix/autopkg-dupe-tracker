# Unity3DAppleTVSupport.munki.recipe

            _Last updated 2021-12-23 19:58:07Z_

            - **Description**: Download the latest version of the Unity Apple TV Support pkg and imports it into a munki_repo.
...
A preinstall script in this support package checks to make sure the same version of Unity 3D is installed, otherwise it fails.
            ...
            - **Identifier**: `com.github.apizz.autopkg.munki.Unity3DAppleTV`

            - **Parent Recipes**: `com.github.apizz.autopkg.download.Unity3DAppleTV`