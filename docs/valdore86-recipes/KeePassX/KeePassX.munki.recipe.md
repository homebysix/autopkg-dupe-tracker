...
- **Description**: Downloads the latest stable (not Alpha) KeePassX and imports it in into Munki.

- **Identifier**: `com.github.valdore86.munki.KeePassX`

- **Parent Recipes**: `com.github.valdore86.verify.KeePassX`
