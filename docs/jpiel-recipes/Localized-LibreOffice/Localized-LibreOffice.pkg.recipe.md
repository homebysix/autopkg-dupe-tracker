...
- **Description**: Downloads the current release version of LibreOffice, merge it with language pack and builds a package.

- **Identifier**: `com.github.jpiel.pkg.Localized-LibreOffice`

- **Parent Recipes**: `com.github.jpiel.download.Localized-LibreOffice`
