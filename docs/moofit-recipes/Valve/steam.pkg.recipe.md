...
- **Description**: Downloads the latest version of Valve's Steam and turns it into a package

- **Identifier**: `com.github.moofit-recipes.pkg.Steam`

- **Parent Recipes**: `com.github.moofit-recipes.download.Steam`
