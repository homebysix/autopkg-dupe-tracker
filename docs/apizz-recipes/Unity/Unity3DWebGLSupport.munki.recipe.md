# Unity3DWebGLSupport.munki.recipe

            _Last updated 2021-12-23 20:01:50Z_

            - **Description**: Download the latest version of the Unity WebGL Support pkg and imports it into a munki_repo.
...
A preinstall script in this support package checks to make sure the same version of Unity 3D is installed, otherwise it fails.
            ...
            - **Identifier**: `com.github.apizz.autopkg.munki.Unity3DWebGL`
